...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">DropShipping</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs pull-right">
            ...
            <li><a href="#tab_1" data-toggle="tab">Tab 3</a></li>
            <li><a href="#tab_2" data-toggle="tab">Tab 2</a></li>
            <li class="active"><a href="#tab_3" data-toggle="tab">Tab 1</a></li>
          </ul>
                ...
                <div class="box-body">
                  <table id="tableDS" class="table table-bordered table-striped dt-responsive" width="100%">
                    ...
                    <!-- <tbody>
                      <tr>
                        <td>1</td>
                        <td><img class="img-thumbnail" src="https://ae01.alicdn.com//kf//HTB1qHVOdRsmBKNjSZFFq6AT9VXaF//Vestido-de-verano-sin-mangas-para-mujer-con-encaje-y-cuello-en-V-Sexy-vestido-con.jpg_50x50.jpg" alt=""> Negro</td>
                        <td>L</td>
