...
<header>
  <!-- Header desktop -->
  <div class="container-menu-desktop" id="header">
    <!-- Topbar -->
    <div class="top-bar">
      <div class="content-topbar flex-sb-m h-full container">
        ...
        <div class="right-top-bar flex-w h-full login">
          ...
          <a href="#loginModal" data-toggle="modal" class="flex-c-m trans-04 p-lr-25">
            My Account
          </a>
            ...
            <li>
              ...
              <ul class="sub-menu">
                <?php
                  ...
                  $categories = ProductsController::ctrShowCategories($item, $val);
                  ...
                  foreach ($categories as $key => $value)
                  {
                    ...
                    $subcategories = ProductsController::ctrShowSubCategories($item, $val);

                    foreach ($subcategories as $key => $value)
                    {
                      echo '<ul class="sub-menu">
                              <li><a href="'.$value["route"].'" class="subcategories">'.$value["subcategory"].'</a></li>
                            </ul>
                          </li>';
                    } */
                  }
    ...
    <ul class="topbar-mobile">
      ...
      <li>
        <div class="right-top-bar flex-w h-full login">
          ...
          <a href="#loginModal" data-toggle="modal" class="flex-c-m p-lr-10 trans-04">
            My Account
          </a>
